...
try {
  ...
  $mail->Username   = 'es-ds1@bk.ru'; // Логин на почте
  $mail->Password   = 'es83812777779'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;
  $mail->setFrom('es-ds1@bk.ru', 'ГПМПК г.Омск'); // Адрес самой почты и имя отправителя
